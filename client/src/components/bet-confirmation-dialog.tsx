...
export function BetConfirmationDialog({
  ...
  const getPremioTypeText = (type: string) => {
    switch (type) {
      ...
      case "6": return "6º Prêmio";
      case "7": return "7º Prêmio";
      case "8": return "8º Prêmio";
      case "9": return "9º Prêmio";
      case "10": return "10º Prêmio";
      case "1-5": return "1º ao 5º Prêmio";
      case "1-10": return "1º ao 10º Prêmio";
