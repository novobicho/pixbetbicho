                      ...
                      <FormControl>
                        ...
                        >
                          <div>
                            ...
                            <Label
                              htmlFor="premio-1"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "1" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>1º</span>
                            </Label>
                          ...
                          <div>
                            ...
                            <Label
                              htmlFor="premio-2"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "2" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>2º</span>
                            </Label>
                          ...
                          <div>
                            ...
                            <Label
                              htmlFor="premio-3"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "3" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>3º</span>
                            </Label>
                          ...
                          <div>
                            ...
                            <Label
                              htmlFor="premio-4"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "4" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>4º</span>
                            </Label>
                          ...
                          <div>
                            ...
                            <Label
                              htmlFor="premio-5"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "5" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>5º</span>
                            </Label>
                          ...
                          <div>
                            ...
                            <Label
                              htmlFor="premio-all"
                              className={`flex flex-col items-center justify-center rounded-md border-2 border-muted bg-popover p-2 hover:bg-accent hover:text-accent-foreground ${field.value === "1-5" ? 'border-primary bg-primary/10' : ''
                                }`}
                            >
                              <span>Todos</span>
                            </Label>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                          {[0.5, 1, 2, 5, 10, 20, 50, 100, 200].map((value) => (
                            <Button
                              ...
                              className={`p-3 h-auto text-sm font-medium ${field.value === value ? "bg-green-600 text-white hover:bg-green-700" : "bg-white"
                                }`}
                              onClick={() => {
                  ...
                  <ul className="space-y-1 text-sm">
                    ...
                    <li className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formValues.premioType === "1-5" ? "Todos (1º ao 5º)" :
                          formValues.premioType === "1-10" ? "Todos (1º ao 10º)" :
