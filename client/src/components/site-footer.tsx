                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/auth" className="text-gray-400 hover:text-white transition-colors">Entrar</Link></li>
                            <li><Link href="/auth?tab=register" className="text-gray-400 hover:text-white transition-colors">Cadastrar</Link></li>
                            <li><Link href="/como-jogar" className="text-gray-400 hover:text-white transition-colors">Como Jogar</Link></li>
                        </ul>
                    </div>
                    <div>
