                ...
                <div className="grid grid-cols-2 items-center">
                  ...
                  <div className="font-medium text-right">
                    {selectedBet.premioType === "1-5" ? "Todos (1º ao 5º)" :
                      selectedBet.premioType === "1-10" ? "Todos (1º ao 10º)" :
                            ...
                            selectedBet.premioType === "3" ? "3º Prêmio" :
                              selectedBet.premioType === "4" ? "4º Prêmio" :
                                selectedBet.premioType === "5" ? "5º Prêmio" :
                                  selectedBet.premioType === "6" ? "6º Prêmio" :
                                    selectedBet.premioType === "7" ? "7º Prêmio" :
                                      selectedBet.premioType === "8" ? "8º Prêmio" :
                                        selectedBet.premioType === "9" ? "9º Prêmio" :
                                          selectedBet.premioType === "10" ? "10º Prêmio" : "-"}
                  </div>
                </div>
